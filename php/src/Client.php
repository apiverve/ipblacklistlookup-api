...
namespace APIVerve\Ipblacklistlookup;
...
/**
 * Client for the IP Blacklist Lookup API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://ipblacklistlookup.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/ipblacklistlookup';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\IpblacklistlookupClient] {$message}\n";
        }
    }
}
