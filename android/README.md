...
```gradle
dependencies {
    implementation 'com.github.apiverve:ipblacklistlookup-api:1.1.14'
}
```
...
```java
import com.apiverve.ipblacklistlookup.IPBlacklistLookupAPIClient;
import com.apiverve.ipblacklistlookup.APIResponse;
import com.apiverve.ipblacklistlookup.APIException;

// Initialize the client
IPBlacklistLookupAPIClient client = new IPBlacklistLookupAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/ipblacklistlookup](https://docs.apiverve.com/ref/ipblacklistlookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/ipblacklistlookup](https://docs.apiverve.com/ref/ipblacklistlookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/ipblacklistlookup-api/issues)
